...
*Next action (2026-08-07 cont6): coverage residual toward 60% (now **57.13%** after memory+status pure; bin **264**). Hard residual = draw_*/slash async I/O/build_tools_inner. REL offline when Docker available. Skip 📌 billing + keys-only smoke.*
