...
| Field | Value |
|-------|--------|
| **Current measured** | **61.65%** lines (16497 / 26757; llvm-cov, 2026-08-09 Swarm-51) — near-term ≥40% **met**; CI ≥60% **met** |
| **CI gate (target)** | ≥ 60% lines via `cargo llvm-cov --fail-under-lines 60` — **met (measured 61.65%)** |
